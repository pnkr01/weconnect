...
Future<void> saveCompanyInfoToFirestore(String name, String batch, String role, String compensation, File logoImage) async {
  try {
    final user = FirebaseAuth.instance.currentUser;
    final companyId = user?.uid; // You may use the user's ID or any other identifier as the document ID.
...
final companyData = {
    ...
    final companyRef = FirebaseFirestore.instance.collection('companies').doc(name);
